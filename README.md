...
```bash
dotnet dev-certs https -v -ep authserver.pfx -p 51a1ffb7-a730-4900-bcc1-02a1e3277999
```

> `51a1ffb7-a730-4900-bcc1-02a1e3277999` is the password of the certificate, you can change it to any password you want.
